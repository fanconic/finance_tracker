...
Template taken from: https://gist.github.com/a-r-d/d2ff471c27d9c8318e81d58a8e9455d8
The following template can be input in your QuantConnect UI.
"""
...
class BasicTemplateAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.SetEndDate(2020,4,17)    #Set End Date
        self.SetCash(1000)           #Set Strategy Cash
        self.SetWarmUp(150) #warm u for 150 days
